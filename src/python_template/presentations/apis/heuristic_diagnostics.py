...
@router.post("/heuristic_diagnostics")
@inject
async def heuristic_diagnostics(
    input_data: schemas.DiagnosticsInput,
    diagnostics_usecase: IDiagnosticUseCase = Depends(
        Provide[Container.hierarchical_diagnostics_usecase]
    ),
